-- Apply retention policy migration manually
-- Based on internal/database/migrations/002_retention_policies.sql
...
-- Update schema version if the table exists
INSERT OR IGNORE INTO schema_versions (version, description) 
SELECT 2, 'Add retention policy management tables'
WHERE EXISTS (SELECT 1 FROM sqlite_master WHERE type='table' AND name='schema_versions'); 